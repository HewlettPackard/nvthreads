...
void initialize()
{
    ...
    STSY_sync_all();
    Q->head = node;
    STSY_store_ptr((void**) &Q->head, node);
    
    Q->tail = node;
    STSY_store_ptr((void**) &Q->tail, node);
}
...
void enqueue(int val)
{
    ...
    STSY_store_ptr((void**) &Q->tail->next, node);
    STSY_store_ptr((void**) &Q->tail, node);
...
int dequeue(int * valp)
{
    ...
    *valp = new_head->val;
    STSY_store_ptr((void**) &Q->head, new_head);
